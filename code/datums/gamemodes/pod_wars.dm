...
proc/setup_pw_crate_lists()
	...
	pw_rewards_tier2 = list(/obj/item/tank/jetpack = 1, /obj/item/explosive/old_grenade/smoke = 2,/obj/item/chem_grenade/flashbang = 2, /obj/item/barrier/collapsible/security = 1,
		/obj/item/explosive/old_grenade/emp = 3, /obj/item/melee/sword/discount = 4, /obj/item/storage/firstaid/crit = 1, /obj/item/fireaxe = 1, /obj/item/dagger/specialist = 2,
	...
	pw_rewards_tier3 = list(/obj/item/firearm/energy/radiological/crossbow = 1, /obj/item/device/chameleon = 1,
		/obj/item/firearm/incidenary/flamethrower/backtank/napalm = 3, /obj/item/ammo/power_cell/self_charging/pod_wars_high = 2,
